...
class _HomeState extends State<Home> {
  ...
  Future<void> sendImageToAPI(List<int> imageBytes) async {
    ...
    Uri apiUrl = Uri.parse('https://d4da-103-138-31-55.ngrok-free.app');
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: OutlinedButton(
                                              onPressed: () async {
                                                //List<int> imageBytes =
                                                //await fetchImageFromFirebase( singleProduct.image);
                                                ...
                                                if (response.statusCode ==
                                                  ...
                                                  Uri apiUrl = Uri.parse(
                                                      'https://d4da-103-138-31-55.ngrok-free.app');
                                                  ...
                                                  if (apiResponse.statusCode ==
                                                      200) {
                                                    logger.d(
                                                        "Image successfully sent to the API");
                                                  } else {
                                                    logger.e(
